...
def bnext():
   ...
   lbl1 = Label(windows,text = q[0],font = ('arial',25,'bold')).pack(side = TOP)
   cb1 = Radiobutton(windows, text=a0[0], value=0,variable = v0,command = checked).pack(side=TOP)
   cb2 = Radiobutton(windows, text=a0[1], value=1,variable = v0,command = checked).pack(side=TOP)
...
lbl00 = Label(root,text = "about Computer Science!", font = ("arial",20,"bold"), fg = 'purple').pack(side = TOP)
